...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  */
    ...
    PB7     ------> I2C1_SDA
    */
    GPIO_InitStruct.Pin = IDO_I2C1_SCL_Pin|IDI_I2C1_SDA_Pin;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  if(hi2c->Instance==I2C1)
  {
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(IDO_I2C1_SCL_GPIO_Port, IDO_I2C1_SCL_Pin);

    HAL_GPIO_DeInit(IDI_I2C1_SDA_GPIO_Port, IDI_I2C1_SDA_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM2)
  {
    ...
    PA3     ------> TIM2_CH4
    */
    GPIO_InitStruct.Pin = GSM_PWR_DRV_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM2;
    HAL_GPIO_Init(GSM_PWR_DRV_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PB8     ------> USART3_TX
    */
    GPIO_InitStruct.Pin = USART3TX_GSMRX_Pin|USART3RX_GSMTX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  else if(huart->Instance==USART3)
  {
    ...
    PB8     ------> USART3_TX
    */
    HAL_GPIO_DeInit(GPIOB, USART3TX_GSMRX_Pin|USART3RX_GSMTX_Pin);
