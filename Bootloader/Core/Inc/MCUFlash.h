...
#define FLASH_PROGRAM_TIMEOUT   100U   // 100 ms timeout for each program operation

#define MCUCONFIG_MEM_START_ADDR (uint32_t)0x0803F800U 
#define MCUCONFIG_MEM_END_ADDR   (uint32_t)0x0803FFFFU
// #define	MCUCONFIG_MEM_START_ADDR	(uint32_t)0x08022800U
// #define	MCUCONFIG_MEM_END_ADDR		(uint32_t)0x0803FFFFU

// #define FLASH_BASE_ADDR FLASH_BASE     // 0x0800_0000
// #define FLASH_BANK_SIZE (128U * 1024U) // 128 KB per bank
...
#define MCU_FLASH_PAGE_SIZE 2048 // 2K = 2048 bytes
#define FLASH_BASE_ADDR       0x08000000UL
#define FLASH_TIMEOUT         5000U   // Adjust as needed
...
typedef enum
{
    MCU_FLASH_NO_STATUS = 0,
    MCU_FLASH_UNLOCK_ERROR,
    MCU_FLASH_LOCK_ERROR,
    MCU_FLASH_WRITING_ERROR,
    MCU_FLASH_WRITING_OK,
    MCU_FLASH_ERASE_OK,
    MCU_FLASH_ERASE_ERROR,
} Enum_FLASHStatus;
