...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef *hadc)
{
  if (hadc->Instance == ADC1)
  {
    ...
    PB0     ------> ADC1_IN8
    */
    HAL_GPIO_DeInit(GPIOA, MAINBATT_ADCIN6_Pin | INTBATT_ADC1IN7_Pin);

    HAL_GPIO_DeInit(INTBATT_CHGSTATUS_ADCIN8_GPIO_Port, INTBATT_CHGSTATUS_ADCIN8_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef *htim)
{
  ...
  if (htim->Instance == TIM2)
  {
    ...
    PA3     ------> TIM2_CH4
    */
    GPIO_InitStruct.Pin = GSM_SUPPLY_CONTROL_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL; // GPIO_PULLUP; // ;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM2;
    HAL_GPIO_Init(GSM_SUPPLY_CONTROL_GPIO_Port, &GPIO_InitStruct);
