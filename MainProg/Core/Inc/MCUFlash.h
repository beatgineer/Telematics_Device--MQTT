...
// #define MCUFLASH_APP_STORAGE_START_ADDR (uint32_t)0x0803F800U
// #define MCUFLASH_APP_STORAGE_END_ADDR (uint32_t)0x0803FFFFU

// #define MCUCONFIG_MEM_START_ADDR		(uint32_t)0x0803F800
// #define MCUCONFIG_MEM_END_ADDR			(uint32_t)0x0803FFFF

// // #define	MCUCONFIG_MEM_START_ADDR	(uint32_t)0x08034000U
// // #define	MCUCONFIG_MEM_END_ADDR		(uint32_t)0x080347FFU
