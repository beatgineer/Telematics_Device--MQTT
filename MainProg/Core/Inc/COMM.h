...
#define RX_BUFFER_SIZE   128  // size for one line of incoming data
// #define TOPIC_MAX_LEN     64  // max length for MQTT topic
// #define PAYLOAD_MAX_LEN   64  // max length for MQTT payload

// // UART receive buffer and state
// static volatile uint8_t  GSM_RxBuffer[RX_BUFFER_SIZE];
// static volatile uint16_t GSM_RxIndex = 0;
// static volatile uint8_t  GSM_RxByte;         // single byte buffer for HAL UART receive
// static volatile uint8_t  GSM_MessageReady = 0;
//*****************************************************************************
//   DEFINITION
//*****************************************************************************
#define DEBUG 1
